defmodule JaxEx.ContentTest do
  use JaxEx.DataCase

  alias JaxEx.Content

  describe "posts" do
    alias JaxEx.Content.Post

    @valid_attrs %{content: "some content", creator_name: "some creator_name", title: "some title"}
    @update_attrs %{content: "some updated content", creator_name: "some updated creator_name", title: "some updated title"}
    @invalid_attrs %{content: nil, creator_name: nil, title: nil}
    ...
    test "create_post/1 with valid data creates a post" do
      ...
      assert post.creator_name == "some creator_name"
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert post.creator_name == "some updated creator_name"
